...
def predict():
    ...
    print("Raw Prediction:", sgd_model.decision_function(input_features))
    prediction = sgd_model.predict(input_features)[0]
    
    # Uncomment these lines to check the raw prediction values and class labels
    raw_predictions = sgd_model.decision_function(input_features)
    print("Raw Predictions:", raw_predictions)
    print("Classes:", sgd_model.classes_)
